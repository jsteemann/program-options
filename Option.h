...
struct Option {
 ...
 Option(std::string const& value, std::string const& description, Parameter* parameter, bool hidden, bool obsolete)
    : section(), name(), description(description), shorthand(), parameter(parameter), hidden(hidden), obsolete(obsolete) {
